...
<div id="dashboard" class="container-fluid">
  ...
  <div class="panel panel-default" style="border: 3px solid #000000;max-width:800px">
                        <div class="panel-heading" style="background-color:#000000;">
                          <?php
                            $psql = pg_query("SELECT firstname, lastname FROM employeeview WHERE pk_user='$eID'");
                          ...
                          ?>
                          <button class="open-button" style="float:right;color:black" onclick="openForm()">Open Form</button>

                            <div class="form-popup" id="myForm">
                              <form action="eupdate.php" class="form-container" method="post">
                              <h1 style="color:black">Update Info</h1>
                              ...
                              <input type="text" placeholder="" name="work" style="color:black" required>
                            ...
                            <div class="table-responsive" style="max-width:800px">
                                ...
                                <table class="table table-striped" style="border-collapse: collapse;max-width:800px">
                                    ...
                                    <tbody>
                                      ...
                                      if(isset($eID)) {
                                        //unset($eID);
                                        $psql = pg_query("SELECT * FROM employeeview WHERE pk_user='$eID'");
                                        $result = pg_fetch_all($psql);
                                        foreach($result as $array) {
                                          $user = $array['pk_user'];
                                          echo '<tr>';
                                          ...
                                          echo '<td>' . $array['iscommission'].'</td></tr>';
                                          //echo '</tr>';
                                        }
                                      } ?>
                                    </tbody>
